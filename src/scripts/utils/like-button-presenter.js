import { LikingAMovie, UnlikingAMovie } from '../views/templates/template-creator';
...
const LikeButtonPresenter = {
  ...
  _renderLike() {
    this._likeButtonContainer.innerHTML = LikingAMovie();
  ...
  _renderLiked() {
    this._likeButtonContainer.innerHTML = UnlikingAMovie();
